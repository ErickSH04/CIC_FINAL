 ...
 * @author Erick
 */
public class ConsultarExpEliminado extends javax.swing.JFrame {
     ...
     */
        ...
        public ConsultarExpEliminado(Paciente paciente, medico medico) {
...
public ConsultarExpEliminado(String ns, medico medico, int id) {
        con = ConexionSQL.ConexionSQLServer();
        this.medico = medico;
        this.id=id;
        initComponents();
    ...
    private void initComponents() {
        ...
        lblAgregar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/borrar.png"))); // NOI18N
        lblAgregar.setText("Consultar eliminados");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ConsultarExpEliminado ae = new ConsultarExpEliminado(ventanaCitasMed.getPaciente(),ventanaMedico.getMedico());
                ae.setVisible(true);
            }
        });
    }
